...
[GitHub](https://github.com/skriptum/quarto-pressmark) [Showcase](https://martenw.com)
...
There are multiple ways to get started with the Pressmark theme. To dig deep into all of them, see the [Setup Guide](setup.llms.md).
...
This should open your website in your browser. Now, adjust the content in the editor of your choice, and see it change in real time. For more detailed instructions, see the [Setup Guide](setup.llms.md).
